...
import { DialogsModule, DeleteConfirmDialog, ConfirmPromotionDialog, ConfirmDemotionDialog, ConfirmLeaveDialog, ConfirmRevokeDialog, EditTagDialog, CreateTagDialog, EditTaskDialog, UnregisterDialog, AddTagDialog, RemoveTeamMemberDialog, UploadDocDialog, UsePredictionDialog } from './dialogs/dialogs.module';
...
@NgModule({
  ...
  entryComponents: [DeleteConfirmDialog, RemoveTeamMemberDialog, ConfirmLeaveDialog, ConfirmDemotionDialog, ConfirmPromotionDialog, ConfirmRevokeDialog, EditTagDialog, CreateTagDialog, EditTaskDialog, UnregisterDialog, AddTagDialog, UploadDocDialog, UsePredictionDialog]
})
